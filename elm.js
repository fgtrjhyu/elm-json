...
var $author$project$Main$Negative = function (a) {
	return {$: 'Negative', a: a};
};
var $author$project$Main$Succeed = function (a) {
	return {$: 'Succeed', a: a};
};
var $author$project$Main$valueFromInt = function (integer) {
	return (integer < 0) ? $author$project$Main$Negative(integer) : ((integer > 100) ? $author$project$Main$Limit(integer) : $author$project$Main$Succeed(integer));
};
var $author$project$Main$NotInteger = function (a) {
	return {$: 'NotInteger', a: a};
};
var $author$project$Main$valueFromString = function (source) {
	if (!$elm$core$String$length(source)) {
		return $author$project$Main$Empty(source);
	} else {
		var _v0 = $elm$core$String$toInt(source);
		if (_v0.$ === 'Nothing') {
			return $author$project$Main$NotInteger(source);
		} else {
			var integer = _v0.a;
			return $author$project$Main$valueFromInt(integer);
		}
	}
};
var $author$project$Main$valueDecoder = $elm$json$Json$Decode$oneOf(
	_List_fromArray(
		[
			A2(
...
var $author$project$Main$encodeValue = function (value) {
	switch (value.$) {
		...
		case 'Negative':
			var integer = value.a;
			return $elm$json$Json$Encode$int(integer);
		case 'Limit':
			var integer = value.a;
			return $elm$json$Json$Encode$int(integer);
		case 'Succeed':
...
var $author$project$Main$InputView = F3(
	function (viewValue, succeed, reason) {
		return {reason: reason, succeed: succeed, viewValue: viewValue};
	});
var $author$project$Main$toInputView = function (value) {
	switch (value.$) {
		case 'Empty':
			var string = value.a;
			return A3(
		...
		case 'NotInteger':
			...
			return A3(
				...
				string,
				false,
				$elm$core$Maybe$Just('not integer'));
		case 'Negative':
			var integer = value.a;
			return A3(
				$author$project$Main$InputView,
				$elm$core$String$fromInt(integer),
				false,
				$elm$core$Maybe$Just('negative'));
		case 'Limit':
			var integer = value.a;
			return A3(
				$author$project$Main$InputView,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Main$reasonToHtml(inputView)
					])),
				A2(
				$elm$html$Html$div,
				_List_Nil,
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Events$onInput($author$project$Main$ValueChanged),
								$elm$html$Html$Attributes$value(inputView.viewValue),
								A2($elm$html$Html$Attributes$style, 'font-size', 'large'),
								A2($elm$html$Html$Attributes$style, 'padding-top', '0.5em'),
								A2($elm$html$Html$Attributes$style, 'padding-bottom', '0.5em'),
								A2(
								$elm$html$Html$Attributes$style,
								'border-color',
								inputView.succeed ? 'green' : 'red'),
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Events$onClick($author$project$Main$Remove)
							]),
						_List_fromArray(
							[
